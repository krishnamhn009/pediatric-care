...
files_to_fix = [
    "client/src/pages/IntakePage.tsx",
    "client/src/pages/SpecialistRecommendationPage.tsx",
    "client/src/pages/MasterHealthRecordPage.tsx"
]
...
# Remove all dark: classes for true minimalism
...
def process_file(filepath):
    ...
    # clean up multiple spaces left by stripped dark classes
